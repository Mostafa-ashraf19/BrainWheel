...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default="computer_vision/od_model/cfgs/yolov3.cfg",
                        help="Neural network profile path. (default=cfgs/yolov3.cfg)")
    parser.add_argument("--names", type=str, default="computer_vision/od_model/data/coco.names",
                        help="Types of objects detected. (default=data/coco.names)")
    parser.add_argument("--weights", type=str, default="computer_vision/od_model/weights/yolov3.pth",
                        help="Model file weight path. (default=weights/yolov3.pth")
    parser.add_argument("--source", type=str, default="computer_vision/od_model/data/examples",
                        help="Image input source. (default=data/examples)")
    parser.add_argument("--output", type=str, default="computer_vision/od_model/output",
