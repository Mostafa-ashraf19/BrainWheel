...
class expScenario(QWidget):
    ...
    def __init__(self,boxes_num = 4,session_period= cylcle *flash_time*8, flash_time = flash_time, static_time = flash_time):
    ...
    def window_comp (self):
        ...
        container.layout().addWidget( self.boxes[1],0,2)
        container.layout().addWidget( self.boxes[2],2,0)
...
class DataAcquisition_thread():
    ...
    def save_file(self,label):
       ...
       self.bci_demo.save_data(file_name,label) # self.bci_demo.data,
